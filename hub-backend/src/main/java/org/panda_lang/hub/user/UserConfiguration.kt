...
internal open class UserConfiguration {
    ...
    @Bean
    open fun authenticationUserDetailsService(userRepository: UserRepository): UserDetailsService {
        return UserDetailsService(userRepository)
    }

    @Bean
    open fun defaultOAuth2UserService(userRepository: UserRepository): OAuth2UserDetailsService {
        return UserOAuth2DetailsService(userRepository)
    }
