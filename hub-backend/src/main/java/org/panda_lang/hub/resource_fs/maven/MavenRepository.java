...
class MavenRepository extends AbstractResourcesRepository<RepositoryResource> {
    ...
    public ResourcesPathMapper initializeMapper() {
        HubApplication.getLogger().info("Loading maven repositories from " + super.getRepositoryRoot() + "...");
    ...
    @Override
    public void onLoad() {
        HubApplication.getLogger().info(getEntities().size() + " maven repositories have been found");
    }
